...
func (g *Gauge5) IncSealed() { g.add(&g.sealed) }
func (g *Gauge5) IncOpened() { g.add(&g.opened) }
func (g *Gauge5) IncRotated() { g.add(&g.rotated) }
func (g *Gauge5) IncRevoked() { g.add(&g.revoked) }
func (g *Gauge5) IncFailed() { g.add(&g.failed) }
