...
func (g *Gauge3) IncSealed() { g.add(&g.sealed) }
func (g *Gauge3) IncOpened() { g.add(&g.opened) }
func (g *Gauge3) IncRotated() { g.add(&g.rotated) }
func (g *Gauge3) IncRevoked() { g.add(&g.revoked) }
func (g *Gauge3) IncFailed() { g.add(&g.failed) }
